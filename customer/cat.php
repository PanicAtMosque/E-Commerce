        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control input-xs" id="acat_des" placeholder="enter category type..."></textarea>
            </div>
    ...
    <div class="panel panel-full-color panel-full-success">
      ...
      <div class="panel-body" style="background-color: #501b1d">
        ...
        <div class="col-md-4">    
          ...
          <input type="text" id="scat_des" onkeyup="srch_cat();" placeholder="Enter type..." class="form-control input-xs">   
        </div>
        <div class="col-md-4">
