...
<header>
	...
	<img src="ShopBySyaSya00.png" id="logo">
...
<section class="products-section">
    ...
    <div class="product" data-id="1"data-name="Printing" data-price="10.00">
        <img src="product3.jpeg" alt="Product 3" class="product-img" onclick="showModal('modal3')">
        <h2>Printing</h2>
        <p>RM10</p>
    ...
    <p class="rating-value">Rating: <span id="rating-1">0</span>/5</p>
	<button class="buy-button" onclick="showModal('modal3')">Add to Cart</button>
    </div>
 ...
 <!-- Modal Section -->
    ...
    <div id="modal3" class="modal">
        <div class="modal-content">
            ...
            <h2>Printing</h2>
            <p>brings cherished memories to life by transforming digital images into tangible, high-quality prints for lasting keepsakes or beautiful displays</p>
			<p>Please send your picture to the WhatsApp number in the Contact Us section</p>
			<p>Please pick an item</p>
			<div class="product" data-id="1"data-name="Printing-Keychain" data-price="10.00">
			<h3>Printing-Keychain</h3>
...
<footer>
    <div class="footer-section">
        <a href="aboutUs.html">Return Policy</a>
        <p>We offer a 30-day return policy on all items. Please read our full policy for more details.</p>
    </div>

    <div class="footer-section">
        <a href="aboutUs.html">About Us</a>
        <p>We are a customer-focused eCommerce company dedicated to providing high-quality products at affordable prices.</p>
    </div>

    <div class="footer-section">
        <a href="aboutUs.html">Contact Us</a>
        <p>Email:arwenpaul1@gmail.com<br>Phone:+60 11-3656-1451</p>
    </div>
</footer>
