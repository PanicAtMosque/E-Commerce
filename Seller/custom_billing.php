...
require 'config.php';
$conn = connection();
$sql = "select * from customer_info order by customer_name";
$data = $conn->query($sql);
...
<div class="col-md-12">
	<div class="col-md-12">
		<div class="panel panel-full-color panel-danger">
			<div class="panel-heading panel-heading-contrast" style="background-color:#a2092d;"><strong>CUSTOM BILLING</strong>
					...
					<span id="srch_ty">
						...
						<div class="col-md-12">
							...
							<div class="col-md-2" style="margin-left: -12%">
								<a class="btn btn-space md-trigger btn-primary" onclick="add_custom_row();" style="float: right;"><i class="icon icon-left mdi mdi-plus"></i>&nbsp;ADD PRODUCT</a>
							</div>
							<div class="col-md-2">
