            ...
            <ul class="nav navbar-nav navbar-right be-user-nav">
              <li class="dropdown"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="dropdown-toggle"><img src="assets/img/avatar.png" alt="Avatar"><span class="user-name">Admin</span></a>
                <ul role="menu" class="dropdown-menu">
                  ...
                  <li><a href="../../E-Commerce/login.php"><span class="icon mdi mdi-power"></span> Logout</a></li>
                </ul>
              </li>
            </ul>
            <div class="page-title"><span>Shopbysyasya Management System</span></div>
            
          </div>
        </div>
      </nav>
      <div class="be-left-sidebar " style="background-color: #1e1538; position: fixed;">
            ...
            <div class="left-sidebar-scroll">
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li><a id="firm" onclick="callPro(this.id);" style="cursor: pointer; color: white;"><i class="icon mdi mdi-store"></i><span>Customer Section</span></a>
                  </li>

                  <li><a id="cat" onclick="callPro(this.id);" style="cursor: pointer; color: white;"><i class="icon mdi mdi-receipt"></i><span>Categories</span></a>
                  </li>

                  <li><a id="ty" onclick="callPro(this.id);" style="cursor: pointer; color: white;"><i class="icon mdi mdi-shape"></i><span>Stuff</span></a>
                  </li>
