  ...
  <div class="modal-dialog custom-width" style="height:200px;">
    <div class="modal-content">
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-3">    
          <label class="control-label panel-subtitle" style="color:white;font-size:20px;">Search by Customer</label>      
          <select class="form-control input-xs" required="" id="spro_firm" onchange="srch_pro();">
            <option value="">Select customer</option>
            <?php foreach ($firm_data1 as $fd1){ ?>
            <option value="<?php echo $fd1['customer_id']; ?>"><?php echo ucwords($fd1['customer_name']);; ?></option>
            <?php } ?>
          </select>    
        </div>
        <div class="col-md-3">
