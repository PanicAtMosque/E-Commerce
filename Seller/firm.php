        ...
        <div class="modal-content">
          <div class="modal-header" style="background-color: #00796B;">
			...
			<div class="form-group">
              ...
              <input type="text" placeholder="enter age" id="customer_name" class="form-control input-xs parsley-error" required="required">
            </div>
            <div class="form-group">
...
<script>
  ...
  { 
    ...
    $.ajax({
      type: "POST",
      url: 'firm_add.php',
      data: {id:id,name:name,age:age,phone:phone,address:address},
      success:function(msg) {
             // alert(msg);
            $('#srch_firm').html(msg);
         }
